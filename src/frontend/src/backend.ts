...
import type { Category as _Category, ExternalBlob as _ExternalBlob, Product as _Product, ProductInput as _ProductInput, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async editProduct(arg0: Product): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editProduct(await to_candid_Product_n13(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterByCategory(arg0: string): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async readProduct(arg0: bigint): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.readProduct(arg0);
